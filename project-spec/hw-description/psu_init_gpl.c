...
/*##################################################################### */
    ...
    * PLL or PHY source selection for gem3_ref_clk generation 0: PLL Reference
    *  clock 1: FMIO PLL clock or GTX Clock
    *  PSU_IOU_SLCR_GEM_CLK_CTRL_GEM3_REF_SRC_SEL                  0x1

    * MIO or FMIO source selection for gem3_rx_clk generation 0: MIO clock 1:
    * FMIO clock
    *  PSU_IOU_SLCR_GEM_CLK_CTRL_GEM3_RX_SRC_SEL                   0x1

    * SoC Debug Clock Control
    * (OFFSET, MASK, VALUE)      (0XFF180308, 0x00018000U ,0x00018000U)
    */
...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRL_APB_PL2_REF_CTRL_DIVISOR0                           0x2e
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E00C8, 0x013F3F07U ,0x01012E02U)
    */
